...
export const etatinvisible = 0;
export const etatvisible = 2;
export const etatcloture = 9;
export const etatvalider = 11;
export const etatalivrer = 21;
export const etatlivre = 31;
export const etatpaye = 40;
